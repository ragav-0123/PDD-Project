                ...
                VStack(spacing: 20) {
                    ...
                    VStack(spacing: 30) {
                        NavigationLink(destination: ActionView()) {
                            GenresOptionButton(title: "Action")
                        }
                        NavigationLink(destination: AdventureView()) {
                            GenresOptionButton(title: "Adventure")
                        }
                        NavigationLink(destination: ComedyView()) {
                            GenresOptionButton(title: "Comedy")
                        }
                        NavigationLink(destination: DramaView()) {
                            GenresOptionButton(title: "Drama")
                        }
                        NavigationLink(destination: FantasyView()) {
                            GenresOptionButton(title: "Fantasy")
                        }
                        NavigationLink(destination: MovieView()) {
                            GenresOptionButton(title: "Movies")
                        }
                    }
...
// Genre Option Button Component
struct GenresOptionButton: View {
    let title: String
